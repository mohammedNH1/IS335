"""
Django settings for IS335django project.
...
SECRET_KEY = 'django-insecure-8w+njtjj21w-ysdoum3m-@oiob8d-ucq#-$_y4(1$qvm9admos'
...
WSGI_APPLICATION = 'IS335django.wsgi.application'
